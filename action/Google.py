...
rawGoogleVoice = requests.get("https://github.com/blackmatrix7/ios_rule_script/blob/master/rule/Clash/GoogleVoice/GoogleVoice.yaml").text
rawGoogleSearch = requests.get("https://github.com/blackmatrix7/ios_rule_script/blob/master/rule/Clash/GoogleSearch/GoogleSearch.yaml").text
rawGoogleEarth = requests.get("https://github.com/blackmatrix7/ios_rule_script/blob/master/rule/Clash/GoogleEarth/GoogleEarth.yaml").text
rawGoogleFCM = requests.get("https://github.com/blackmatrix7/ios_rule_script/blob/master/rule/Clash/GoogleFCM/GoogleFCM.yaml").text
